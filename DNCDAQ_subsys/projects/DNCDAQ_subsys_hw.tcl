...
#
# DNCDAQ_subsys_hw.tcl: Tcl script for re-creating project 'DNCDAQ_subsys_hw'
#
# Generated by Vivado on Tue Oct 12 20:48:02 CST 2021
...
#
# 1. This project restoration tcl script (DNCDAQ_subsys_hw.tcl) that was generated.
#
...
#
#    "/home/dn/verilogggg/DNCDAQ_subsys/axi4l_fifo_if/axi4l_fifo_if.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/axi4l_fifo_if/axi4l_fifo_if_top.v"
#    "/home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675_top.v"
#    "/home/dn/verilogggg/DNCDAQ_subsys/counter/counter.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675_model.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/counter/counter_tb.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675_tb.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/sim/DNCDAQ_subsys_sim.sv"
#    "/home/dn/verilogggg/DNCDAQ_subsys/constrains/debug.xdc"
#    "/home/dn/verilogggg/DNCDAQ_subsys/constrains/physical.xdc"
#    "/home/dn/verilogggg/DNCDAQ_subsys/constrains/timing.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/../../../collection_sys_hw/ip_repo"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "DNCDAQ_subsys_hw"
...
set script_file "DNCDAQ_subsys_hw.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../DNCDAQ_subsys_hw"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../collection_sys_hw/ip_repo"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../ads1675/ads1675.sv"] \
 [file normalize "${origin_dir}/../ads1675/ads1675_top.v"] \
 [file normalize "${origin_dir}/../counter/counter.sv"] \
 [file normalize "${origin_dir}/../ads1675/ads1675_model.sv"] \
 [file normalize "${origin_dir}/../counter/counter_tb.sv"] \
 [file normalize "${origin_dir}/../ads1675/ads1675_tb.sv"] \
 [file normalize "${origin_dir}/../sim/DNCDAQ_subsys_sim.sv"] \
]
...
set file "$origin_dir/../ads1675/ads1675.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../ads1675/ads1675_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../ads1675/ads1675_model.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../ads1675/ads1675_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../sim/DNCDAQ_subsys_sim.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "DNCDAQ_subsys_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../constrains/debug.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constrains/debug.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../constrains/debug.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z100ffg900-2" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../constrains/debug.xdc"]" -objects $obj
...
set_property -name "top" -value "DNCDAQ_subsys_sim" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files axi4l_fifo_if.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/DNCDAQ_subsys/axi4l_fifo_if/axi4l_fifo_if.sv
}
if { [get_files axi4l_fifo_if_top.v] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/DNCDAQ_subsys/axi4l_fifo_if/axi4l_fifo_if_top.v
}
if { [get_files ads1675.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675.sv
}
if { [get_files ads1675_top.v] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/DNCDAQ_subsys/ads1675/ads1675_top.v
}


# Proc to create BD DNCDAQ_subsys
proc cr_bd_DNCDAQ_subsys { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# ads1675_top, axi4l_fifo_if_top



  # CHANGE DESIGN NAME HERE
  set design_name DNCDAQ_subsys
...
# Hierarchical cell: hier_adc
proc create_hier_cell_hier_adc { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_adc() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir O clk_sel
  create_bd_pin -dir O cs_n
  create_bd_pin -dir I dout_n
  create_bd_pin -dir I dout_p
  create_bd_pin -dir O dr0
  create_bd_pin -dir O dr1
  create_bd_pin -dir O dr2
  create_bd_pin -dir I drdy_n
  create_bd_pin -dir I drdy_p
  create_bd_pin -dir I en
  create_bd_pin -dir I -type rst ext_reset_in
  create_bd_pin -dir O fpath
  create_bd_pin -dir O -type intr intr
  create_bd_pin -dir O ll_cfg
  create_bd_pin -dir O lvds
  create_bd_pin -dir O pown
  create_bd_pin -dir I -type clk rd_clk
  create_bd_pin -dir I -type rst rst_n
  create_bd_pin -dir I sclk_n
  create_bd_pin -dir I sclk_p
  create_bd_pin -dir O start

  # Create instance: ads1675_top, and set properties
  set block_name ads1675_top
  set block_cell_name ads1675_top
  if { [catch {set ads1675_top [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ads1675_top eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Full_Threshold_Assert_Value {131069} \
   CONFIG.Full_Threshold_Negate_Value {131068} \
  ...
  # Create instance: proc_sys_reset_sck, and set properties
  set proc_sys_reset_sck [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_sck ]

  # Create interface connections
  connect_bd_intf_net -intf_net s_axi_1 [get_bd_intf_pins s_axi] [get_bd_intf_pins axi4l_fifo_if_top/s_axi]

  # Create port connections
  connect_bd_net -net ADS1675Top_sclk [get_bd_pins ads1675_top/sclk] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins proc_sys_reset_sck/slowest_sync_clk]
  connect_bd_net -net ads1675_top_0_clk_sel [get_bd_pins clk_sel] [get_bd_pins ads1675_top/clk_sel]
  connect_bd_net -net ads1675_top_0_cs_n [get_bd_pins cs_n] [get_bd_pins ads1675_top/cs_n]
  connect_bd_net -net ads1675_top_0_data [get_bd_pins ads1675_top/data] [get_bd_pins fifo_generator_0/din]
  connect_bd_net -net ads1675_top_0_dr0 [get_bd_pins dr0] [get_bd_pins ads1675_top/dr0]
  connect_bd_net -net ads1675_top_0_dr1 [get_bd_pins dr1] [get_bd_pins ads1675_top/dr1]
  connect_bd_net -net ads1675_top_0_dr2 [get_bd_pins dr2] [get_bd_pins ads1675_top/dr2]
  connect_bd_net -net ads1675_top_0_fpath [get_bd_pins fpath] [get_bd_pins ads1675_top/fpath]
  connect_bd_net -net ads1675_top_0_ll_cfg [get_bd_pins ll_cfg] [get_bd_pins ads1675_top/ll_cfg]
  connect_bd_net -net ads1675_top_0_lvds [get_bd_pins lvds] [get_bd_pins ads1675_top/lvds]
  connect_bd_net -net ads1675_top_0_pown [get_bd_pins pown] [get_bd_pins ads1675_top/pown]
  connect_bd_net -net ads1675_top_0_start [get_bd_pins start] [get_bd_pins ads1675_top/start]
  connect_bd_net -net ads1675_top_0_valid [get_bd_pins ads1675_top/valid] [get_bd_pins fifo_generator_0/wr_en]
  connect_bd_net -net axi4l_fifo_if_top_0_intr [get_bd_pins intr] [get_bd_pins axi4l_fifo_if_top/intr]
  connect_bd_net -net axi4l_fifo_if_top_0_rx_fifo_rd [get_bd_pins axi4l_fifo_if_top/rx_fifo_rd] [get_bd_pins fifo_generator_0/rd_en]
  connect_bd_net -net dout_n_1 [get_bd_pins dout_n] [get_bd_pins ads1675_top/dout_n]
  connect_bd_net -net dout_p_1 [get_bd_pins dout_p] [get_bd_pins ads1675_top/dout_p]
  connect_bd_net -net drdy_n_1 [get_bd_pins drdy_n] [get_bd_pins ads1675_top/drdy_n]
  connect_bd_net -net drdy_p_1 [get_bd_pins drdy_p] [get_bd_pins ads1675_top/drdy_p]
  connect_bd_net -net en_1 [get_bd_pins en] [get_bd_pins ads1675_top/en]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_sck/ext_reset_in]
  ...
  connect_bd_net -net fifo_generator_0_rd_data_count [get_bd_pins axi4l_fifo_if_top/rx_fifo_dcnt] [get_bd_pins axi4l_fifo_if_top/tx_fifo_dcnt] [get_bd_pins fifo_generator_0/rd_data_count]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets fifo_generator_0_rd_data_count]
  connect_bd_net -net proc_sys_reset_sck_peripheral_aresetn [get_bd_pins ads1675_top/rst_n] [get_bd_pins proc_sys_reset_sck/peripheral_aresetn]
  connect_bd_net -net rd_clk_1 [get_bd_pins rd_clk] [get_bd_pins axi4l_fifo_if_top/clk] [get_bd_pins fifo_generator_0/rd_clk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi4l_fifo_if_top/rst_n]
  connect_bd_net -net sclk_n_1 [get_bd_pins sclk_n] [get_bd_pins ads1675_top/sclk_n]
  connect_bd_net -net sclk_p_1 [get_bd_pins sclk_p] [get_bd_pins ads1675_top/sclk_p]
  ...
  # Create ports
  set clk_sel [ create_bd_port -dir O clk_sel ]
  set cs_n [ create_bd_port -dir O cs_n ]
  set dout_n [ create_bd_port -dir I dout_n ]
  set dout_p [ create_bd_port -dir I dout_p ]
  set dr0 [ create_bd_port -dir O dr0 ]
  set dr1 [ create_bd_port -dir O dr1 ]
  set dr2 [ create_bd_port -dir O dr2 ]
  set drdy_n [ create_bd_port -dir I drdy_n ]
  set drdy_p [ create_bd_port -dir I drdy_p ]
  set fpath [ create_bd_port -dir O fpath ]
  set ll_cfg [ create_bd_port -dir O ll_cfg ]
  set lvds [ create_bd_port -dir O lvds ]
  set pown [ create_bd_port -dir O pown ]
  set sclk_n [ create_bd_port -dir I sclk_n ]
  set sclk_p [ create_bd_port -dir I sclk_p ]
  set start [ create_bd_port -dir O start ]

  # Create instance: adc_enable, and set properties
  set adc_enable [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 adc_enable ]
  set_property -dict [ list \
  ...
  # Create instance: hier_adc
  create_hier_cell_hier_adc [current_bd_instance .] hier_adc
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#UART 0#UART 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins hier_adc/s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins adc_enable/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net adc_enable_gpio_io_o [get_bd_pins adc_enable/gpio_io_o] [get_bd_pins hier_adc/en]
  connect_bd_net -net dout_n_1 [get_bd_ports dout_n] [get_bd_pins hier_adc/dout_n]
  connect_bd_net -net dout_p_1 [get_bd_ports dout_p] [get_bd_pins hier_adc/dout_p]
  connect_bd_net -net drdy_n_1 [get_bd_ports drdy_n] [get_bd_pins hier_adc/drdy_n]
  connect_bd_net -net drdy_p_1 [get_bd_ports drdy_p] [get_bd_pins hier_adc/drdy_p]
  connect_bd_net -net hier_adc_clk_sel [get_bd_ports clk_sel] [get_bd_pins hier_adc/clk_sel]
  connect_bd_net -net hier_adc_cs_n [get_bd_ports cs_n] [get_bd_pins hier_adc/cs_n]
  connect_bd_net -net hier_adc_dr0 [get_bd_ports dr0] [get_bd_pins hier_adc/dr0]
  connect_bd_net -net hier_adc_dr1 [get_bd_ports dr1] [get_bd_pins hier_adc/dr1]
  connect_bd_net -net hier_adc_dr2 [get_bd_ports dr2] [get_bd_pins hier_adc/dr2]
  connect_bd_net -net hier_adc_fpath [get_bd_ports fpath] [get_bd_pins hier_adc/fpath]
  connect_bd_net -net hier_adc_intr [get_bd_pins hier_adc/intr] [get_bd_pins xlconcat_0/In0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets hier_adc_intr]
  connect_bd_net -net hier_adc_ll_cfg [get_bd_ports ll_cfg] [get_bd_pins hier_adc/ll_cfg]
  connect_bd_net -net hier_adc_lvds [get_bd_ports lvds] [get_bd_pins hier_adc/lvds]
  connect_bd_net -net hier_adc_pown [get_bd_ports pown] [get_bd_pins hier_adc/pown]
  connect_bd_net -net hier_adc_start [get_bd_ports start] [get_bd_pins hier_adc/start]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins proc_sys_reset_200M/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins adc_enable/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hier_adc/rst_n] [get_bd_pins proc_sys_reset_200M/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins adc_enable/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins hier_adc/rd_clk] [get_bd_pins proc_sys_reset_200M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins hier_adc/ext_reset_in] [get_bd_pins proc_sys_reset_200M/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net sclk_n_1 [get_bd_ports sclk_n] [get_bd_pins hier_adc/sclk_n]
  connect_bd_net -net sclk_p_1 [get_bd_ports sclk_p] [get_bd_pins hier_adc/sclk_p]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs adc_enable/S_AXI/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier_adc/axi4l_fifo_if_top/s_axi/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.515235",
   "Default View_TopLeft":"330,0",
   "ExpandedHierarchyInLayout":"/hier_adc",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 2290 -y 1200 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 2290 -y 1220 -defaultsOSRD
preplace port clk_sel -pg 1 -lvl 5 -x 2290 -y 570 -defaultsOSRD
preplace port cs_n -pg 1 -lvl 5 -x 2290 -y 790 -defaultsOSRD
preplace port dout_n -pg 1 -lvl 0 -x -60 -y 590 -defaultsOSRD
preplace port dout_p -pg 1 -lvl 0 -x -60 -y 610 -defaultsOSRD
preplace port dr0 -pg 1 -lvl 5 -x 2290 -y 650 -defaultsOSRD
preplace port dr1 -pg 1 -lvl 5 -x 2290 -y 710 -defaultsOSRD
preplace port dr2 -pg 1 -lvl 5 -x 2290 -y 690 -defaultsOSRD
preplace port drdy_n -pg 1 -lvl 0 -x -60 -y 630 -defaultsOSRD
preplace port drdy_p -pg 1 -lvl 0 -x -60 -y 1090 -defaultsOSRD
preplace port fpath -pg 1 -lvl 5 -x 2290 -y 670 -defaultsOSRD
preplace port ll_cfg -pg 1 -lvl 5 -x 2290 -y 630 -defaultsOSRD
preplace port lvds -pg 1 -lvl 5 -x 2290 -y 610 -defaultsOSRD
preplace port pown -pg 1 -lvl 5 -x 2290 -y 550 -defaultsOSRD
preplace port sclk_n -pg 1 -lvl 0 -x -60 -y 1110 -defaultsOSRD
preplace port sclk_p -pg 1 -lvl 0 -x -60 -y 1130 -defaultsOSRD
preplace port start -pg 1 -lvl 5 -x 2290 -y 590 -defaultsOSRD
preplace inst adc_enable -pg 1 -lvl 4 -x 1220 -y 2398 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 3 -x 810 -y 940 -defaultsOSRD
preplace inst hier_adc -pg 1 -lvl 4 -x 1220 -y 164 -defaultsOSRD
preplace inst proc_sys_reset_200M -pg 1 -lvl 2 -x 430 -y 880 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 430 -y 1240 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -x 120 -y 1250 -defaultsOSRD
preplace inst hier_adc|proc_sys_reset_sck -pg 1 -lvl 1 -x 1460 -y 474 -defaultsOSRD
preplace inst hier_adc|fifo_generator_0 -pg 1 -lvl 1 -x 1460 -y 194 -defaultsOSRD
preplace inst hier_adc|axi4l_fifo_if_top -pg 1 -lvl 2 -x 1880 -y 394 -defaultsOSRD
preplace inst hier_adc|ads1675_top -pg 1 -lvl 2 -x 1880 -y 754 -defaultsOSRD
preplace netloc adc_enable_gpio_io_o 1 3 2 1030 986 2240
preplace netloc dout_n_1 1 0 4 -40J 82 NJ 82 NJ 82 1030J
preplace netloc dout_p_1 1 0 4 -30J 102 NJ 102 NJ 102 1020J
preplace netloc drdy_n_1 1 0 4 -20J 122 NJ 122 NJ 122 1010J
preplace netloc drdy_p_1 1 0 4 -10J 142 NJ 142 NJ 142 1000J
preplace netloc hier_adc_intr 1 0 5 20 1080 NJ 1080 NJ 1080 1000J 1754 2250
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 2 1 N 900
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 2 630 800 1020
preplace netloc processing_system7_0_FCLK_CLK0 1 1 3 230 780 640 780 1010
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 3 220 770 650 202 960J
preplace netloc sclk_n_1 1 0 4 10J 182 NJ 182 NJ 182 980J
preplace netloc sclk_p_1 1 0 4 0J 162 NJ 162 NJ 162 990J
preplace netloc xlconcat_0_dout 1 1 1 NJ 1250
preplace netloc hier_adc_pown 1 4 1 2270J 550n
preplace netloc hier_adc_clk_sel 1 4 1 2270J 570n
preplace netloc hier_adc_start 1 4 1 2270J 590n
preplace netloc hier_adc_lvds 1 4 1 2270J 610n
preplace netloc hier_adc_ll_cfg 1 4 1 2270J 630n
preplace netloc hier_adc_dr0 1 4 1 2270J 650n
preplace netloc hier_adc_fpath 1 4 1 2270J 670n
preplace netloc hier_adc_dr2 1 4 1 2270J 690n
preplace netloc hier_adc_dr1 1 4 1 2270J 710n
preplace netloc hier_adc_cs_n 1 4 1 2270J 790n
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 1220 960J 1894 2270J
preplace netloc axi_interconnect_0_M00_AXI 1 3 1 970 334n
preplace netloc processing_system7_0_DDR 1 2 3 NJ 1200 970J 1874 2260J
preplace netloc S00_AXI_1 1 2 1 660 860n
preplace netloc axi_interconnect_0_M01_AXI 1 3 1 990 950n
preplace netloc hier_adc|ADS1675Top_sclk 1 0 3 1260 574 NJ 574 2060
preplace netloc hier_adc|ext_reset_in_1 1 0 1 1190 454n
preplace netloc hier_adc|rd_clk_1 1 0 2 1180 354 N
preplace netloc hier_adc|rst_n_1 1 0 2 1210J 374 N
preplace netloc hier_adc|fifo_generator_0_dout 1 0 2 1250 344 1700J
preplace netloc hier_adc|fifo_generator_0_full 1 0 2 1230 44 1710
preplace netloc hier_adc|fifo_generator_0_rd_data_count 1 1 1 1670 194n
preplace netloc hier_adc|ads1675_top_0_pown 1 2 1 2090 554n
preplace netloc hier_adc|ads1675_top_0_clk_sel 1 2 1 2070 574n
preplace netloc hier_adc|ads1675_top_0_start 1 2 1 2130 594n
preplace netloc hier_adc|ads1675_top_0_lvds 1 2 1 2100 614n
preplace netloc hier_adc|ads1675_top_0_ll_cfg 1 2 1 2110 634n
preplace netloc hier_adc|ads1675_top_0_dr0 1 2 1 N 654
preplace netloc hier_adc|ads1675_top_0_fpath 1 2 1 2120 674n
preplace netloc hier_adc|ads1675_top_0_dr2 1 2 1 N 694
preplace netloc hier_adc|ads1675_top_0_dr1 1 2 1 2080 674n
preplace netloc hier_adc|ads1675_top_0_cs_n 1 2 1 N 794
preplace netloc hier_adc|dout_p_1 1 0 2 1170J 654 1670
preplace netloc hier_adc|drdy_n_1 1 0 2 NJ 634 1710
preplace netloc hier_adc|dout_n_1 1 0 2 1200J 644 1680
preplace netloc hier_adc|drdy_p_1 1 0 2 NJ 664 1690
preplace netloc hier_adc|sclk_p_1 1 0 2 NJ 684 N
preplace netloc hier_adc|sclk_n_1 1 0 2 NJ 704 N
preplace netloc hier_adc|en_1 1 0 2 NJ 954 1690
preplace netloc hier_adc|proc_sys_reset_sck_peripheral_aresetn 1 1 1 1700 514n
preplace netloc hier_adc|ads1675_top_0_data 1 0 3 1220 934 NJ 934 2110
preplace netloc hier_adc|ads1675_top_0_valid 1 0 3 1230 944 NJ 944 2060
preplace netloc hier_adc|axi4l_fifo_if_top_0_intr 1 2 1 N 444
preplace netloc hier_adc|axi4l_fifo_if_top_0_rx_fifo_rd 1 0 3 1240 54 NJ 54 2090
preplace netloc hier_adc|s_axi_1 1 0 2 NJ 334 N
levelinfo -pg 1 -60 120 430 810 1220 2290
levelinfo -hier hier_adc * 1460 1880 *
pagesize -pg 1 -db -bbox -sgen -160 0 2410 2480
pagesize -hier hier_adc -db -bbox -sgen 1140 34 2160 964
"
}
...
# End of cr_bd_DNCDAQ_subsys()
cr_bd_DNCDAQ_subsys ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files DNCDAQ_subsys.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files DNCDAQ_subsys.bd ] 
set_property IS_ENABLED "1" [get_files DNCDAQ_subsys.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files DNCDAQ_subsys.bd ] 
set_property IS_LOCKED "0" [get_files DNCDAQ_subsys.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files DNCDAQ_subsys.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files DNCDAQ_subsys.bd ] 
set_property PFM_NAME "" [get_files DNCDAQ_subsys.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files DNCDAQ_subsys.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files DNCDAQ_subsys.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files DNCDAQ_subsys.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files DNCDAQ_subsys.bd ] 
set_property USED_IN_SIMULATION "1" [get_files DNCDAQ_subsys.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files DNCDAQ_subsys.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse DNCDAQ_subsys.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../DNCDAQ_subsys_hw/DNCDAQ_subsys_hw.gen/sources_1/bd/DNCDAQ_subsys/hdl/DNCDAQ_subsys_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse DNCDAQ_subsys.bd] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z100ffg900-2 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dn/collection_sys_hw/collection_sys_hw.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z100ffg900-2 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dn/collection_sys_hw/collection_sys_hw.srcs/utils_1/imports/impl_1" -objects $obj

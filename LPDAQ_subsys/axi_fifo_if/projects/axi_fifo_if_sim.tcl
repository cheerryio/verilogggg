...
#
# axi_fifo_if_sim.tcl: Tcl script for re-creating project 'axi_fifo_if_sim'
#
# Generated by Vivado on Thu Oct 28 13:59:05 CST 2021
...
#
# 1. This project restoration tcl script (axi_fifo_if_sim.tcl) that was generated.
#
...
#
#    "/home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_data.sv"
#    "/home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_intr.sv"
#    "/home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_if_top.v"
#    "/home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_if_tb.sv"
#
#*****************************************************************************************
...
set _xil_proj_name_ "axi_fifo_if_sim"
...
set script_file "axi_fifo_if_sim.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../axi_fifo_if_sim"]"
...
set files [list \
 [file normalize "${origin_dir}/../axi_fifo_data.sv"] \
 [file normalize "${origin_dir}/../axi_fifo_intr.sv"] \
 [file normalize "${origin_dir}/../axi_fifo_if_top.v"] \
 [file normalize "${origin_dir}/../axi_fifo_if_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../axi_fifo_data.sv"
...
set file "$origin_dir/../axi_fifo_intr.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../axi_fifo_if_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../axi_fifo_if_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "axi_fifo_if_top" -objects $obj
set_property -name "top_file" -value "../axi_fifo_if_top.v" -objects $obj
...
set_property -name "top" -value "axi_fifo_if_tb" -objects $obj
...
if { [get_files axi_fifo_data.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_data.sv
}
if { [get_files axi_fifo_intr.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_intr.sv
}
if { [get_files axi_fifo_if_top.v] == "" } {
  import_files -quiet -fileset sources_1 /home/dn/verilogggg/LPDAQ_subsys/axi_fifo_if/axi_fifo_if_top.v
}


# Proc to create BD axi_fifo_if_sim
proc cr_bd_axi_fifo_if_sim { parentCell } {
...
# axi_fifo_if_top
  ...
  set design_name axi_fifo_if_sim
  ...
  # Create ports
  set aux_rst_n [ create_bd_port -dir I -type rst aux_rst_n ]
  set clk [ create_bd_port -dir I -type clk clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {rst_n:aux_rst_n} \
 ] $clk
  set data [ create_bd_port -dir I -from 23 -to 0 data ]
  set rst_n [ create_bd_port -dir I -type rst rst_n ]
  set valid [ create_bd_port -dir I valid ]

  # Create instance: axi_fifo_if_top_0, and set properties
  set block_name axi_fifo_if_top
  set block_cell_name axi_fifo_if_top_0
  if { [catch {set axi_fifo_if_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_fifo_if_top_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PROG_EMPTY_THRESH {100} \
   CONFIG.PROG_FULL_THRESH {400} \
  ...
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins axi_fifo_if_top_0/s_axi] [get_bd_intf_pins axi_vip_0/M_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_fifo_if_top_0/s_axis] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]

  # Create port connections
  connect_bd_net -net aux_reset_in_0_1 [get_bd_ports aux_rst_n] [get_bd_pins proc_sys_reset_0/aux_reset_in]
  connect_bd_net -net axis_data_fifo_0_prog_empty [get_bd_pins axi_fifo_if_top_0/prog_empty] [get_bd_pins axis_data_fifo_0/prog_empty]
  connect_bd_net -net axis_data_fifo_0_prog_full [get_bd_pins axi_fifo_if_top_0/prog_full] [get_bd_pins axis_data_fifo_0/prog_full]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins axi_fifo_if_top_0/clk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_fifo_if_top_0/rst_n] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net s_axis_tdata_0_1 [get_bd_ports data] [get_bd_pins axis_data_fifo_0/s_axis_tdata]
  connect_bd_net -net s_axis_tvalid_0_1 [get_bd_ports valid] [get_bd_pins axis_data_fifo_0/s_axis_tvalid]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs axi_fifo_if_top_0/s_axi/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-153,-37",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port clk -pg 1 -lvl 0 -x -10 -y 20 -defaultsOSRD
preplace port rst_n -pg 1 -lvl 0 -x -10 -y 90 -defaultsOSRD
preplace port valid -pg 1 -lvl 0 -x -10 -y 250 -defaultsOSRD
preplace port aux_rst_n -pg 1 -lvl 0 -x -10 -y 110 -defaultsOSRD
preplace portBus data -pg 1 -lvl 0 -x -10 -y 230 -defaultsOSRD
preplace inst axi_vip_0 -pg 1 -lvl 2 -x 540 -y 80 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 2 -x 540 -y 250 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 200 -y 110 -defaultsOSRD
preplace inst axi_fifo_if_top_0 -pg 1 -lvl 3 -x 860 -y 140 -defaultsOSRD
preplace netloc clk_0_1 1 0 3 10 10 380 10 710
preplace netloc s_axis_tdata_0_1 1 0 2 NJ 230 NJ
preplace netloc s_axis_tvalid_0_1 1 0 2 NJ 250 NJ
preplace netloc axis_data_fifo_0_prog_empty 1 2 1 700 170n
preplace netloc axis_data_fifo_0_prog_full 1 2 1 710 190n
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 390 150 N
preplace netloc rst_n_1 1 0 1 N 90
preplace netloc aux_reset_in_0_1 1 0 1 N 110
preplace netloc axis_data_fifo_0_M_AXIS 1 2 1 690 90n
preplace netloc axi_vip_0_M_AXI 1 2 1 700 80n
levelinfo -pg 1 -10 200 540 860 1020
pagesize -pg 1 -db -bbox -sgen -140 0 1020 350
"
}
...
# End of cr_bd_axi_fifo_if_sim()
cr_bd_axi_fifo_if_sim ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files axi_fifo_if_sim.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files axi_fifo_if_sim.bd ] 
set_property IS_ENABLED "1" [get_files axi_fifo_if_sim.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files axi_fifo_if_sim.bd ] 
set_property IS_LOCKED "0" [get_files axi_fifo_if_sim.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files axi_fifo_if_sim.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files axi_fifo_if_sim.bd ] 
set_property PFM_NAME "" [get_files axi_fifo_if_sim.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files axi_fifo_if_sim.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files axi_fifo_if_sim.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files axi_fifo_if_sim.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files axi_fifo_if_sim.bd ] 
set_property USED_IN_SIMULATION "1" [get_files axi_fifo_if_sim.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files axi_fifo_if_sim.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse axi_fifo_if_sim.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../../axi_fifo_if_sim/axi_fifo_if_sim.gen/sources_1/bd/axi_fifo_if_sim/hdl/axi_fifo_if_sim_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse axi_fifo_if_sim.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dn/test/test.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/dn/test/test.srcs/utils_1/imports/impl_1" -objects $obj
